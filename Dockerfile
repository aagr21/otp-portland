...
# # Establece el comando por defecto para construir el gráfico
# ENTRYPOINT ["java", "-jar", "opentripplanner.jar"]
...
CMD ["java", "-Xmx100m", "-jar", "opentripplanner.jar", "--load", "--serve", "/var/opentripplanner"]